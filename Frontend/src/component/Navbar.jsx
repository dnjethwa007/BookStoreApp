...
function Navbar() {
    ...
    return (
        <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed z-50 left-0 right-0 top-0 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out":""}`}>
                ...
                <div className="navbar-end flex items-center space-x-3">
                    ...
                    <div className="hidden md:flex items-center ml-4">
                        <label className="flex items-center gap-2 px-3 py-2 rounded-md border">
                            <input type="text" className="grow outline-none dark:bg-slate-900 dar:text-white " placeholder="Search" />
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 16 16"
                                fill="currentColor"
